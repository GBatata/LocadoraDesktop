...
public class TelaPrincipal extends JFrame {
  ...
  private void montar() {
    ...
    rodape.add(new JLabel(identificacao), BorderLayout.WEST);

    rodape.add(new JLabel( "Sistema de Locadora - Java Desktop" ), BorderLayout.EAST);
  ...
  private JMenuBar criarMenu() {
    ...
    sobre.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          JOptionPane.showMessageDialog(TelaPrincipal.this, "Sistema didatico de Locadora\n" + "Java Desktop + Swing + JDBC + MySQL", "Sobre", JOptionPane.INFORMATION_MESSAGE);
        }
      });
  ...
  public void abrirAba(String titulo, JPanel painel) {
    ...
    abas.setTabComponentAt(abas.indexOfComponent(painel), cabecalhoFechavel(titulo, painel));
  ...
  private JPanel cabecalhoFechavel(String titulo, final Component painel) {
    JPanel cabecalho =
      new JPanel(new FlowLayout( FlowLayout.LEFT, 3, 0 ));
  ...
  private void sair() {
    if (JOptionPane.showConfirmDialog( this, "Deseja encerrar o sistema?", "Sair", JOptionPane.YES_NO_OPTION ) == JOptionPane.YES_OPTION) {
      dispose();
      System.exit(0);
    }
  }
